...
Org profile, shared community files, and org workflows.
Public home copy: [`docs/HOME.oot`](docs/HOME.oot). That board
loads at https://openooda.org (route `home`). This repo is not
a product sidebar item.
